	...
	<div class="profile-container">
		<aside class="profile-sidebar">
			...
			<nav class="sidebar-nav">
				<button class="nav-item active"
					onclick="showSection('basic-info', this)">
					<i class="fas fa-user"></i> Profile Settings
				</button>
				<button class="nav-item"
					onclick="showSection('password-section', this)">
		...
		<main class="profile-content">
			...
			<section id="basic-info" class="content-section active">
				<div class="section-header">
					...
					<div class="header-text">
						...
						<p class="section-subtitle">Manage your profile details and
					...
					<div class="form-grid">
						<div class="form-group">
							<label>Full Name <span class="required">*</span></label> <input
								type="text" name="fullName" value="${passenger.fullName}"
								required> <span class="error-text">${nameError}</span>
						</div>
						<div class="form-group">
							<label>Email<span class="required">*</span></label> <input type="email"
								value="${passenger.email}" required>
						</div>
						<div class="form-group">
							<label>Mobile Number <span class="required">*</span></label>
							<div class="phone-input">
								<span class="country-code">NP +977</span> <input type="text"
									name="phone" value="${passenger.contactNumber}" required>
							</div>
							<span class="error-text">${phoneError}</span>
						</div>
						<div class="form-group">
							<label>Date of Birth <span class="required">*</span></label> <input
								type="date" name="dob" value="${passenger.dob}" required>
						...
						<div class="form-group">
							...
							<div class="gender-options">
								<label class="radio-label"> <input type="radio"
									...
									${passenger.gender == 'Male' ? 'checked' : ''}> <span>Male</span>
								</label> <label class="radio-label"> <input type="radio"
									name="gender" value="Female"
									${passenger.gender == 'Female' ? 'checked' : ''}> <span>Female</span>
								</label>
							</div>
						</div>
					</div>
			...
			<section id="password-section" class="content-section">
				...
				<p class="section-subtitle">Ensure your account is using a long,
				...
				<form action="${pageContext.request.contextPath}/profile"
					...
					<div class="info-box">
						<p>
							<strong>Please note:</strong> After you change your password, you
							will be automatically logged out of all devices for security
							reasons.
						</p>
					</div>
