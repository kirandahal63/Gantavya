                        ...
                        <div class="input-grid" style="grid-template-columns: 1fr 1fr 1fr 1fr;">
                            <div class="box">
                                ...
                                <div class="inner-input">
                                    ...
                                    <input type="text" id="from-location" placeholder="Kathmandu" value="${searchFrom}">
                            ...
                            <div class="box">
                                ...
                                <div class="inner-input">
                                    <i class="fa-solid fa-location-dot"></i>
                                    <input type="text" id="to-location" placeholder="Pokhara" value="${searchTo}">
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="inner-input" onclick="openCalendar()" style="cursor: pointer;">
                                    ...
                                    <input type="text" id="display-date" value="${searchDate}" readonly
        ...
        .search-result-card {
            ...
            <main class="container" style="margin-top: 40px;margin-bottom: 80px;">
                <div class="booking-results">
                        ...
                        <span id="buses-found-count" style="color: #666; font-size: 14px;">
                            <c:choose>
                                <c:when test="${isFallback}">
                                    <span style="color: #e62222; font-weight: 600;"><i class="fa-solid fa-circle-exclamation"></i> ${fallbackMessage}</span>
                                </c:when>
                                <c:otherwise>
                    ...
                    <div id="no-buses-msg" style="${empty trips ? 'display: block;' : 'display: none;'} text-align: center; padding: 50px; background: white; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
