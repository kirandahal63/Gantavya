...
<body>
			...
			<div class="search-card">
				...
				<div class="input-grid">
					...
					<div class="box">
						...
						<div class="inner-input">
							<i class="fa-solid fa-location-dot"></i> <input type="text"
								id="to-location" placeholder="Pokhara">
						</div>
					</div>
					<div class="box">
						...
						<div class="inner-input"
							...
							<i class="fa-regular fa-calendar"></i> <input type="text"
								id="departure-date" placeholder="Today, 5 May" readonly
	...
	<main class="container">
		...
		<div class="section-head">
			...
			<a href="${pageContext.request.contextPath}/search">View All
				Trips</a>
		</div>
			...
			<c:forEach var="trip" items="${trips}">
				<div class="route-card">
					...
					<div class="path-viz">
						<!-- Departure Point -->
						<div class="point">
							<i class="fa-regular fa-circle-dot"></i> <span> <strong>${trip.departureDate}</strong>
								${trip.source}
							</span>
						</div>
						...
						<!-- Arrival Point -->
						<div class="point">
							<i class="fa-solid fa-location-dot arrival-icon"></i> <span>
								<strong>${trip.arrivalDate}</strong> ${trip.destination}
							</span>
						</div>
					</div>

					<div class="card-footer">
						<span><i class="fa fa-bus"></i> ${trip.availableSeats}
							Seats Left</span> <a href="booking?tripId=${trip.tripId}">BOOK
							JOURNEY</a>
					</div>
				</div>
			</c:forEach>
