...
<head>
    ...
    <style>
        ...
        height: 100vh;
        width: 100vw;
        background-image: url('${pageContext.request.contextPath}/images/500.png');
...
<body>
    <div class="error-page-wrapper">
        <div class="text-content">
            ...
            <h1>Oops! Looks like<br>our server is...</h1>
            <p>Unreachable, like this bus that<br>broke down on a bridge!</p>
